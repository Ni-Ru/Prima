...
(function (Script) {
    ...
    function start(_event) {
        ...
        cmpEngine = ship.getComponent(Script.SpaceShipControls);
...
(function (Script) {
    ...
    class SpaceShipControls extends ƒ.ComponentScript {
        // Register the script as component for use in the editor via drag&drop
        static iSubclass = ƒ.Component.registerSubclass(SpaceShipControls);
        ...
        yaw(_value) {
            this.rigidbody.applyTorque(ƒ.Vector3.SCALE(this.node.mtxWorld.getY(), _value * -10));
        }
        pitch(_value) {
            this.rigidbody.applyTorque(ƒ.Vector3.SCALE(this.node.mtxWorld.getX(), _value * -5));
        }
        roll(_value) {
